...
#define _nstates8	204	/* p7 */
#define minseq8	374
#define maxseq8	576
#define _endstate8	203

#define _nstates7	34	/* p6 */
#define minseq7	341
#define maxseq7	373
#define _endstate7	33

#define _nstates6	204	/* p5 */
#define minseq6	138
#define maxseq6	340
#define _endstate6	203

#define _nstates5	34	/* p4 */
#define minseq5	105
#define maxseq5	137
#define _endstate5	33
...
#define _nstates1	19	/* entorno */
#define minseq1	57
#define maxseq1	74
#define _endstate1	18

#define _nstates0	58	/* fsm */
#define minseq0	0
#define maxseq0	56
...
typedef struct State {
	...
	#endif
#endif
	unsigned coche_sec : 1;
	unsigned btn_p_princ : 1;
	unsigned btn_p_sec : 1;
	unsigned t_min : 1;
	unsigned t_max : 1;
	unsigned t_ambar : 1;
	unsigned peat_princ : 1;
	unsigned peat_sec : 1;
	uchar sem_princ;
	uchar sem_sec;
	uchar fsm_estado;
