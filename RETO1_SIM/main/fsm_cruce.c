...
static void model_clear_btn_p_princ(fsm_t *this)
{
    model_fsm_t *model_fsm = (model_fsm_t *)this;
    *model_fsm->btn_p_princ = 0;
}

static void model_clear_btn_p_sec(fsm_t *this)
{
    model_fsm_t *model_fsm = (model_fsm_t *)this;
    *model_fsm->btn_p_sec = 0;
}

static void model_clear_coche_sec(fsm_t *this)
{
    model_fsm_t *model_fsm = (model_fsm_t *)this;
